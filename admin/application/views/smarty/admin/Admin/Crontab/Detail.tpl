                                        ...
                                        <form role="form" method="post">
                                            ...
                                            <div class="form-group form-material row  ">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input class="form-control" id="username" name="username" placeholder="用户名必填,最少3位"  value="{{$data.username}}">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="email" class="text-danger">邮箱<small>(*)</small></label>
                                                    <input class="form-control" id="email" name="email" placeholder="如不修改,请不要填写"  value="{{$data.email}}">
                                                </div>
                                            </div>
                                            <div class="form-group form-material row">
                                                <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input class="form-control" id="number" name="number" value="{{$data.number}}" maxlength="20">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group form-material row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input class="form-control" id="department" name="department" placeholder="例如:财务部"  value="{{$data.department}}">
                                                </div>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group form-material">
                                                ...
                                                <input class="form-control" id="job" name="job" placeholder="例如:工程师"  value="{{$data.job}}">
                                            </div>
                                            ...
                                            <div class="form-group form-material">
                                                ...
                                                <div class="radio-custom radio-success">
                                                    <input type="radio" id="status1" name="status"  {{if $data.status==1}}checked="checked"{{/if}} {{if $data.id==$sessionid}}disabled{{/if}} value="1">
                                                    <label for="status1" >正常</label>

                                                    <input type="radio" id="status2" name="status" {{if $data.status==2}}checked="checked"{{/if}} {{if $data.id==$sessionid}}disabled{{/if}} value="2" >
                                                    <label for="status2" >选中（禁用）</label>

                                                    <input type="radio" id="status3" name="status" {{if $data.status==3}}checked="checked"{{/if}} {{if $data.id==$sessionid}}disabled{{/if}}value="3">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <select class="form-control" id="group_id[]" name="group_id[]" multiple="multiple" size="5">
                                                    ...
                                                    <option value="{{$value.id}}" {{if in_array($value.id,$data.group_id)}}selected{{/if}}>{{$value.name}}</option>
                                                    {{/foreach}}
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <textarea id="description" name="description" rows="5" class="form-control" value="{{$data.description}}"></textarea>
                                            </div>
