                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <form role="form" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="url" name="url" placeholder="必填项, 例如: /Admin_User/List 或者 http://www.baidu.com"  value="">
                                            </div>

                                            <div class="form-group">
                                                <label for="controller">Controller</label>
                                                <input class="form-control" id="controller" name="controller" placeholder="Controller名称"  value="">
                                            </div>

                                            <div class="form-group">
                                                <label for="action">Action</label>
                                                <input class="form-control" id="action" name="action"  placeholder="Action名称"  value="">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio"  value="1" id="show_yes" name="pub_show" checked="checked">显示
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" value="0" id="show_no" name="pub_show">不显示
                                                    </label>
                                                </div>
                                            </div>
