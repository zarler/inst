...
<div class="input-group date form_date col-md-5" data-date="{{if isset($datepk_style.date)}}{{$datepk_style.date}}{{else}}{{date('Y-m')}}{{/if}}" data-date-format="yyyy-mm" data-link-field="dtp_input" data-link-format="yyyy-mm">
</div>
