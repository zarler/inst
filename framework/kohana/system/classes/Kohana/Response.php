...
class Kohana_Response implements HTTP_Response {
	...
	public function send_file($filename, $download = NULL, array $options = NULL)
	{
		...
		$this->_header['Accept-length']      = ($end - $start) + 1;
		...
		//var_dump($this->send_headers());
		// Send all headers now
		//$this->send_headers();
		//var_dump($download);
		//var_dump($_SERVER['SCRIPT_NAME']);
		$filepath='../upload/20160222/b840a63b32e089a04ac002df90a76d48.png';
		...
		Header("Accept-Length: 2235");
		Header("Content-Disposition: attachment; filename=" . $download);
		echo fread($file, 2235);
		fclose($file);
		exit;
		while (ob_get_level())
		{
