            ...
            <div class="page-content">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="icon wb-grid-9" aria-hidden="true"></i>螺丝帽</h3>
                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <form action="/{{$_controller}}/{{$_action}}" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="usableBalance">短信余量</label>
                                                <input class="form-control" id="usableBalance" name="usableBalance" value="{{if isset($data['deposit'])}}{{$data['deposit']}}{{/if}}" autocomplete="on">
                                            </div>
