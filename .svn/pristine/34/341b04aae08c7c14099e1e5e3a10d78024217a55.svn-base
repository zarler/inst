                                    ...
                                    <table class="table table-striped  table-hover ">
                                      <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/{{$_controller}}/GroupEdit?id={{$value.id}}" class="btn btn-primary btn-sm">更改</a>
                                                <a href="/{{$_controller}}/GroupDelete?id={{$value.id}}" name="delete_btn"  class="btn bg-danger btn-sm">删</a>
                                            </td>
                                        </tr>
                                        {{/foreach}}
                                        </tbody>
