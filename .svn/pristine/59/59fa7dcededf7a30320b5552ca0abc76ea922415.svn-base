 ...
 * 产品费率模型
 */
abstract class Model_Abstract_ProductRate extends Model_Database
{
    ...
    public function getDayInterestRate(){
        return $this->day_interest_rate;
    }

    public function getMonthInterestRate(){
        return $this->month_interest_rate;
    }


    public function getDayPenaltyRate(){
        return $this->day_penalty_rate;
    }

    public function getDayLateFeeRate(){
        return $this->day_late_fee_rate;
    }

    public function getPenaltyMaxDay(){
