...
$(function () {
    ...
    $("#booroot-navbarFullscreen").click(function () {

        var is_active = $(this).find("a").is(".active");
    ...
    $("#booroot-toggleMenubar").click(function () {

        if($("html").is('.css-menubar')==true){
            $("html").removeClass("css-menubar");
            $("body").addClass("site-contabs-open site-menubar-fold");
            $(".navbar-header .navbar-toggle-left").addClass("unfolded");
        }else{
            $("html").addClass("css-menubar");
            $("body").removeClass("site-contabs-open site-menubar-fold");
        }
    ...
    $(".site-menu li").click(function () {
       ...
       // $("body").addClass("site-menubar-fold-hover");
        ...
        //  $(this).find("ul").css("max-height","260px");
    });

    $("#booroot-navMenu ul li ").not('.dropdown').click(function () {

        var selector = $(this).find("a").attr("aria-controls");

        $(this).addClass("active");
        $(this).siblings().removeClass("active");

        $("#booroot-navTabs .tab-pane").each(function () {

            if($(this).attr('aria-controls')==selector){
    ...
    $("#booroot-navbarSubMenu").click(function () {
     ...
     $("#contabs_wrap li ").click(function () {
         var controls = $(this).find('a').attr("aria-controls");

         $(this).addClass('active').siblings().removeClass('active');
         $("[id$='"+controls+"']").addClass('active').siblings().removeClass('active');
    ...
    //
    $(".msg-btn").mousemove(function () {
        $(".dropdown .dropdown-menu").show();
    }).mouseout(function () {
        $(".dropdown .dropdown-menu").hide();
    });

    $(".dropdown-menu li a[role=select]").click(function(){
        
          $(this).parent().addClass('active').siblings().removeClass('active');
         $(this).parents('ul').siblings("button[data-toggle=dropdown]").not('.caret').html($(this).text()+'<span class="caret"></span>');
...
$(document).ready(function(){
    ...
    $("#booroot-navTabs .menu-icon-li").mouseenter(function(){
        $(this).addClass('hover');
    }).mouseleave(function(){
