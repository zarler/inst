                                        ...
                                        <form role="form" method="post">
                                            ...
                                            <div class="form-group form-material">
                                                ...
                                                <div class="radio-custom radio-success">
                                                    <input type="radio" id="status1" name="status"  {{if $data.status==1}}checked="checked"{{/if}}   value="1">
                                                    <label for="status1" >正常</label>

                                                    <input type="radio" id="status2" name="status" {{if $data.status==2}}checked="checked"{{/if}}  value="2" >
                                                    <label for="status2" >选中（禁用）</label>

                                                    <input type="radio" id="status3" name="status" {{if $data.status==3}}checked="checked"{{/if}} value="3">
