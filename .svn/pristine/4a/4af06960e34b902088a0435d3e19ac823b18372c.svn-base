                                        ...
                                        <div class="col-lg-6">
                                            <form role="form" method="post" id="v_form">
                                                <div class="form-group">
                                                    <label for="title">服务商名</label>
                                                    <input class="form-control" id="name" name="name"  placeholder="必填项" maxlength="25" value="{{$data.name}}">
                                                </div>

                                                <div class="form-group">
                                                    <label for="body">服务商编码</label>
                                                    <input class="form-control" id="provider" name="provider" placeholder="必填项" maxlength="25" value="{{$data.provider}}">
                                                </div>

                                                <div class="form-group">
                                                    <label for="code">描述</label>
                                                    <textarea id="desc" name="desc" rows="5" class="form-control">{{$data.desc}}</textarea>
                                                </div>
