...
return array(
    ...
    'SMS' => array(
        ...
        //发送短信地址
        'send_url' => 'http://sms-api-luosimao-com.http.p.timecash.cn/v1/send.json',
        ////查询短信剩余条数地址
        'status_url' => 'http://sms-api-luosimao-com.http.p.timecash.cn/v1/status.json',
    ),
    ...
    'PS' => array(
        ...
        'ps_url'		=> 'http://ps.inst.timecash.cn',	//test.ps.inst.timecash.cn
    ),
    ...
    'FaceID' => array(
        ...
        'server' => 'http://api-faceid-com.http.p.timecash.cn/faceid/v1',
        'server_v2' => 'http://api-megvii-com.https.p.timecash.cn/faceid/v2',
    ),

    //极光推送
    'JPush' => [
        'apns_production' => true,//测试false  线上true
        'app_key'         => '33b5d39fd37d4579aa126119',
        'master_secret'   => '19dd48a1ffa4417143557196',
...
//        'master_secret'   => 'b5c7191d47cd11f83efda09f',//测试
    ...
    //魔蝎数据
    'Moxie' => array(
        'ApiKey' => 'f1ee00048a964723ae3d2666aa1309c6',
        'Token' => 'f5c6b17963144bfb8c903f559e653de9',
        'Secret' => '27c7e4bc518c48d095d9caf544771876',
        'backUrl' => 'http://app.inst.timecash.cn/v1/v/CallbackAddress/MoXie',
        ...
        'ChsiPath' => '/index.html#/chsi',   //学信网path
    ),
