...
class Lib_ZhiCheng_IdNosSubmit {
    private $tx='301';
    //所有发送数据
    ...
    function getuserid() {
        $public_content=file_get_contents(APPPATH.'classes/Lib/ZhiCheng/ZC_PublicKey_V2.pem');
    ...
    public function getallRequestData(array $data = []) {
        $json_arr=array('tx'=>$this->tx, 'data'=>array('idNo'=>explode(',',$data['idNos'])));
