...
class DClient
{
    ...
    const SEND_DATA_REQUEST_URL = 'http://test.sunfund.com/importData';
    const QUERY_DATA_REQUEST_URL = 'http://test.sunfund.com/checkDetail';
    ...
    public function post($query)
    {
        ...
        $this->_method = 'POST';
        $this->_postdata = $this->value_string($query);
