...
<p class="tip-p">请输入您的工作信息</p>

<section class="t-credit-w contact1">
    <p class="t-credit-input border-bottom">
        <?php echo Form::input('companyname','',array('class'=>'form-control text_width_70','placeholder'=>'请输入公司名称'));?>
    </p>
    <p class="t-credit-input border-bottom" data-toggle="distpicker">
        <span style="z-index: 1; height: 26px;float: left;margin-right:10px;color: #222222">公司所在地</span>
    ...
    <p class="t-credit-input border-bottom">
        <?php echo Form::input('companydetail','',array('class'=>'form-control text_width_70','placeholder'=>'请输入公司详细地址'));?>
    </p>
    <p class="t-credit-input">
        <?php echo Form::input('companytell','',array('class'=>'form-control text_width_70','placeholder'=>'公司联系电话（固话请包含区号）'));?>
    </p>
</section>
